# TC2 : Valet parking – 5 hours or less – lower boundary (1 minute)
...
def test_example(page: Page) -> None:
    ...
    page.locator("#LeavingTime").fill("08:01")
    page.get_by_role("button", name="Calculate").click()
    expect(page.get_by_role("rowgroup")).to_contain_text("$ 12.00")
    expect(page.get_by_role("rowgroup")).to_contain_text("(0 Days, 0 Hours, 1 Minutes)")
